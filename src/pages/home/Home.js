        ...
        <div className="Home">
            ...
            <section id="home" className="Home-hero-section">
                <div className="Home-hero-div-main">
                    <h1 className="Home-hero-div-title">Lorem ipsum dolor sit amet<br/>consectetur bibendum<br/>adipiscing elit</h1>
                    <h2 className="Home-hero-div-desc">Imperdiet aliquam, quam amet aenean quis bibendum augue elementum. Id id posuere ultrices sapien nisl.</h2>
                    <div className="Home-hero-div-buttons-container">
                        <Link className="Home-hero-div-button-filled" to={"/apply"}>Apply for a role</Link>
                        <HashLink className="Home-hero-div-button-unfilled" smooth to={"#about"}>Learn more</HashLink>
                    </div>
                </div>
            ...
            <section id="about" className="Home-about">
                ...
                <div className="Home-about-content">
                    <AboutCard
                        title={"Lorem ipsum"}
                        image={aboutCardImg}
                        description={"Lorem ipsum dolor sit amet, consectetur adipiscing eliquet nibh libero aliquet integer. Lorem ipsum dolor sit amet, consectetur adipiscing eliquet nibh libero aliquet."}
                    />
                    <AboutCard
                        title={"Lorem ipsum"}
                        image={aboutCardImg}
